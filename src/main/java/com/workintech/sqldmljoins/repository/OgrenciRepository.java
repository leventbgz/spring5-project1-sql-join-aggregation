...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT o.sinif, o.ad, o.soyad, COUNT(i.kitapno) FROM ogrenci o INNER JOIN islem i ON o.ogrno = i.ogrno WHERE o.sinif IN('10A', '10B') GROUP BY o.sinif, o.ad, o.soyad";
    ...
    String QUESTION_8 = "SELECT o.sinif, COUNT(o.ogrno) FROM ogrenci AS o GROUP BY o.sinif ORDER BY sinif DESC";
